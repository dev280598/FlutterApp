...
import 'package:flutter_app/screens/view/drawing_canvas/models/drawing_mode.dart';
import 'package:flutter_app/screens/view/drawing_canvas/models/sketch.dart';
...
class DrawingCanvas extends HookWidget {
  ...
  void onPointerDown(PointerDownEvent details, BuildContext context) {
    ...
    if (currentSketch.value?.type == SketchType.text) {}
    debugPrint('onPointerDown $details \n ${currentSketch.value?.type}');
  }
    ...
    return SizedBox(
      ...
      child: ValueListenableBuilder<List<Sketch>>(
        ...
        builder: (context, sketches, _) {
          debugPrint('buildAllSketches $sketches');
          return Stack(
            children: [
              RepaintBoundary(
                key: canvasGlobalKey,
              ...
              if (currentSketch.value?.type == SketchType.text) ...[
                Positioned(
                  left: sketches.lastOrNull?.points.firstOrNull?.dx,
                  top: sketches.lastOrNull?.points.firstOrNull?.dy,
                  child: SizedBox(
                    width: 300,
                    child: TextField(
    ...
    return Listener(
      ...
      child: ValueListenableBuilder(
        ...
        builder: (context, sketch, child) {
          debugPrint('buildCurrentPath ${sketch?.points}');
          return Stack(
            children: [
              RepaintBoundary(
                child: SizedBox(
              ...
              if (currentSketch.value?.type == SketchType.text) ...[
                Positioned(
                  left: sketch?.points.firstOrNull?.dx,
                  top: sketch?.points.firstOrNull?.dy,
                  child: SizedBox(
                    width: 300,
                    child: TextField(
                      controller: TextEditingController(),
